...
const Sidebar = ({selectedTab,setSelectedTab}) => {
    ...
    return (
    <div className="d-flex  side-bar flex-column flex-shrink-0 p-3 text-bg-dark" style={{width: "180px"}}>
    ...
    <ul className="nav nav-pills flex-column mb-auto">
      ...
      <li onClick={ ()=>handleOnClick("Create Post")}>
        <a href="#" className={`${selectedTab==='Create Post'?'active':''} text-white  nav-link link-body-emphasis`}>
